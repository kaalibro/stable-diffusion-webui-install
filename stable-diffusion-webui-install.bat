...
echo [93m╔═══════════════════════════════════════════════════════════════════════╗[0m
echo [93m║                          === READ FIRST: ===                          ║[0m
echo [93m║[0m [96mCLEAN INSTALL:[0m[93m                                                        ║[0m
echo [93m║ Run this script from the directory where Stable Diffusion web UI      ║[0m
echo [93m║ should be located after installation.                                 ║[0m
echo [93m║                                                                       ║[0m
echo [93m║[0m [96mREINSTALLATION:[0m[93m                                                       ║[0m
echo [93m║ Place this script in the same directory as your current installation  ║[0m
echo [93m║ (not in the directory itself, but next to it) and specify the name of ║[0m
echo [93m║ the directory where you want to reinstall Stable Diffusion web UI.    ║[0m
echo [93m╚═══════════════════════════════════════════════════════════════════════╝[0m
echo.
...
if exist !INSTALL_DIR! (
  ...
  echo ║                           ^^!^^!^^! WARNING ^^!^^!^^!                             ║
  echo ║                                                                       ║
  echo ║      This script will delete the current Stable Diffusion web UI      ║
  echo ║                installation in the specified folder^^!                  ║
  echo ║                                                                       ║
  echo ║              MAKE SURE YOU MAKE THE NECESSARY BACKUPS^^!                ║
  echo ║                                                                       ║
  echo ╚═══════════════════════════════════════════════════════════════════════╝[0m
  echo.
